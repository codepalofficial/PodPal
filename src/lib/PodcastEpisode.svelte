...
<!-- <div class="p-10">
	<Card size="lg" padding="lg">
		<h5 class="text-xl">{episode.name}</h5>
...
<Accordion>
	<AccordionItem>
	  <span slot="header">{episode.name}</span>
	  <div slot="arrow-up">
	  ...
	  <p class="mb-2 text-gray-500 dark:text-gray-400">{episode.description}</p>
	</AccordionItem>
  </Accordion>
